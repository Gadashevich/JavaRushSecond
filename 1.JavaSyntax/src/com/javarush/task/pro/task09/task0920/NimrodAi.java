...
public class NimrodAi {
    ...
    public static void main(String[] args) {
        if (checkPirates("diningRoom")) openFloodgates("diningRoom");
        if (checkPirates("o2")) openFloodgates("o2");
        if (checkPirates("medRoom")) openFloodgates("medRoom");
        if (checkPirates("armoury")) openFloodgates("armoury");
        if (checkPirates("securityRoom")) openFloodgates("securityRoom");
        if (checkPirates("reactor")) openFloodgates("reactor");
        if (checkPirates("telecom")) openFloodgates("telecom");
        if (checkPirates("warehouse")) openFloodgates("warehouse");
        if (checkPirates("controlRoom")) openFloodgates("controlRoom");
        if (checkPirates("powerRoom")) openFloodgates("powerRoom");
